...
var (
	testEgtsSrTermIdentityBin = []byte{0xB0, 0x09, 0x02, 0x00, 0x00, 0x00, 0x00, 0x00, 0x10}
	...
	testEgtsSrTermIdentityPkgBin = []byte{0x01, 0x00, 0x03, 0x0B, 0x00, 0x13, 0x00, 0x86, 0x00, 0x01, 0xB6, 0x08, 0x00,
		0x5F, 0x00, 0x99, 0x02, 0x00, 0x00, 0x00, 0x01, 0x01, 0x01, 0x05, 0x00, 0xB0, 0x09, 0x02, 0x00, 0x00, 0x00,
		0x00, 0x00, 0x10, 0x11, 0xCE}
	testEgtsSrTermIdentityPkg = Package{
		...
		ServicesFrameDataCheckSum: 52753,
	}
)
