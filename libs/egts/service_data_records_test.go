...
func TestServiceDataRecord_Encode(t *testing.T) {
	...
	testServiceDataRecordBytes := []byte{0x00, 0x00, 0x61, 0x00, 0x99, 0xB0, 0x09, 0x02, 0x00, 0x00, 0x00, 0x00, 0x00,
		0x02, 0x02}
...
func TestServiceDataRecord_Decode(t *testing.T) {
	...
	testServiceDataRecordBytes := []byte{0x18, 0x00, 0x61, 0x00, 0x99, 0xB0, 0x09, 0x02, 0x00, 0x00, 0x00, 0x00, 0x00,
	 	0x02, 0x02}
